...
The weights of the TNet model reported in the paper, can be downloaded [here](https://drive.google.com/uc?export=download&confirm&id=11xk3DqB_966XPZSGThTr6h-Rbm4sRGjJ). <br />
