...
The weights of the TNet model reported in the paper, can be downloaded [here](https://docs.google.com/u/0/uc?export=download&confirm=4xUu&id=11xk3DqB_966XPZSGThTr6h-Rbm4sRGjJ). <br />
